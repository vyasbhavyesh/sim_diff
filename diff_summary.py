...
def get_diff_summary(diff_data, col_diff, col_orphan_pre, col_orphan_post, row_diff, row_orphan_pre, row_orphan_post, dest_path ):
   ...
   # if col_diff:
       # orphan_cols = [col_orphan_pre[1], col_orphan_post[1]]
    ...
    summary += 'Orphan Rows Pre: ' + str(row_orphan_pre[0]) + ' No. of rows- ' + str(row_orphan_pre[1]) + '\n'+ '\n'
    summary += 'Orphan Rows Post: ' + str(row_orphan_post[0]) + ' No. of rows- ' + str(row_orphan_post[1]) + '\n'+ '\n'
    summary += 'Orphan Columns: ' + str(col_diff) + '\n'+ '\n'
    summary += 'Orphan Columns Pre: ' + str(col_orphan_pre[0]) + ' Names- ' +  str(col_orphan_pre[1]) + '\n'+ '\n'
    summary += 'Orphan Columns Post: ' + str(col_orphan_post[0]) + ' Names-' + str(col_orphan_post[1]) + '\n'+ '\n'
